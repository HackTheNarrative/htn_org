...
class RWMB_Core {
	...
	public function init() {
		load_plugin_textdomain( 'activism', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="https://metabox.io/docs/">' . esc_html__( 'Documentation', 'activism' ) . '</a>';
		$links[] = '<a href="https://metabox.io/plugins/">' . esc_html__( 'Extensions', 'activism' ) . '</a>';
		return $links;
	}
