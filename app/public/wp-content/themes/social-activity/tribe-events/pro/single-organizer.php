	...
	<div class="cmsms_events_organizer_header clearfix">
		...
		<div class="cmsms_events_organizer_header_right clearfix">
			<h6 class="tribe-events-back">
				<a class="cmsms-icon-calendar-2" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( __( 'Back to %s', 'tribe-events-calendar-pro' ), tribe_get_event_label_plural() ); ?></a>
			</h6>
		</div>
	</div>
