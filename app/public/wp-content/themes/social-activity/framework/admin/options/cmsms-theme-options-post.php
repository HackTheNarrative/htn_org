...
$tabs_array['cmsms_post'] = array( 
	'label' => esc_html__('Post', 'social-activity'), 
	'value'	=> 'cmsms_post' 
);
...
$custom_post_meta_fields = array( 
	...
	array( 
		'label'	=> __('Aside Text', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Status Text', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Chat Text', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Quote Text', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Quote Author', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Link Text', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Link Address', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Post Image', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Post Gallery', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Audio Links', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Post Title', 'social-activity'), 
	...
	array( 
		'label'	=> __("'Read More' Buttons Text", 'social-activity'), 
		'desc'	=> __("Enter the 'Read More' button text that should be used in you blog shortcode", 'social-activity'), 
		'id'	=> $cmsms_option_name . 'read_more', 
		'type'	=> 'text', 
		'hide'	=> '', 
		'std'	=> __('Read More', 'social-activity') 
	), 
	array( 
		'id'	=> 'cmsms_post', 
		'type'	=> 'tab_finish' 
	...
	array( 
		'label'	=> __('Page Layout', 'social-activity'), 
		'desc'	=> '', 
		'id'	=> 'cmsms_layout', 
		'type'	=> 'radio_img', 
		'hide'	=> '', 
		...
		'options' => array( 
			'r_sidebar' => array( 
				...
				'label' => __('Right Sidebar', 'social-activity'), 
				'value'	=> 'r_sidebar' 
			), 
			'l_sidebar' => array( 
				'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
				'label' => __('Left Sidebar', 'social-activity'), 
				'value'	=> 'l_sidebar' 
			), 
			'fullwidth' => array( 
				'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
				'label' => __('Full Width', 'social-activity'), 
				'value'	=> 'fullwidth' 
			) 
		) 
	), 
	array( 
		'label'	=> __('Choose Right\Left Sidebar', 'social-activity'), 
		'desc'	=> '', 
		'id'	=> 'cmsms_sidebar_id', 
		'type'	=> 'select_sidebar', 
		'hide'	=> 'true', 
