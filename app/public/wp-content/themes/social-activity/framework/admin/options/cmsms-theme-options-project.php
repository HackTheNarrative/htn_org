...
$cmsms_global_portfolio_project_details_title = (isset($cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title']) && $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] !== '') ? $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] : __('Project details', 'social-activity');
...
$tabs_array['cmsms_project'] = array( 
	'label' => esc_html__('Project', 'social-activity'), 
	'value'	=> 'cmsms_project' 
);


$tabs_array['cmsms_layout'] = array( 
	'label' => esc_html__('Layout', 'social-activity'), 
	'value'	=> 'cmsms_layout' 
);
...
if ($cmsms_global_bg) {
	$tabs_array['cmsms_bg'] = array( 
		'label' => esc_html__('Background', 'social-activity'), 
		'value'	=> 'cmsms_bg' 
	);
}
...
$tabs_array['cmsms_heading'] = array( 
	'label' => esc_html__('Heading', 'social-activity'), 
	'value'	=> 'cmsms_heading' 
);
...
$custom_project_meta_fields = array( 
	...
	array( 
		'label'	=> __('Project Images', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Number of Columns', 'social-activity'), 
		'desc'	=> '', 
		...
		'options' => array( 
			'three' => array( 
				'label' => __('Three', 'social-activity'), 
				'value'	=> 'three' 
			), 
			'two' => array( 
				'label' => __('Two', 'social-activity'), 
				'value'	=> 'two' 
			), 
			'one' => array( 
				'label' => __('One', 'social-activity'), 
				'value'	=> 'one' 
			) 
		) 
	),
	...
	array( 
		'label'	=> __('Video Type', 'social-activity'), 
		'desc'	=> '', 
		...
		'options' => array( 
			'embedded' => array( 
				'label' => __('Embedded (YouTube, Vimeo)', 'social-activity'), 
				'value'	=> 'embedded' 
			), 
			'selfhosted' => array( 
				'label' => __('Self-Hosted', 'social-activity'), 
				'value'	=> 'selfhosted' 
			) 
		) 
	), 
	array( 
		'label'	=> __('Embedded Video Link', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Self-Hosted Video Links', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Title', 'social-activity'), 
	...
	array( 
		'label'	=> __('Project Size', 'social-activity'), 
		'desc'	=> __('Recomended Featured Image dimensions', 'social-activity') . ' - ', 
	...
	array( 
		'label'	=> __('Project Details Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Info', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __("Project Link Text", 'social-activity'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 'link_text', 
		'type'	=> 'text', 
		'hide'	=> '', 
		'std'	=> __('View Project', 'social-activity') 
	), 
	array( 
		'label'	=> __("Project Link URL", 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> '', 
		'desc'	=> __('Redirect to project link URL instead of opening project page', 'social-activity'), 
	...
	array( 
		'label'	=> __("Project Link Target", 'social-activity'), 
		'desc'	=> __('Open link in a new tab', 'social-activity'), 
	...
	array( 
		'label'	=> __('Project Features 1 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Features 1', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Features 2 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Features 2', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Features 3 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Project Features 3', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Sharing Box', 'social-activity'), 
		'desc'	=> __('Show', 'social-activity'), 
	...
	array( 
		'label'	=> __('About Author Box', 'social-activity'), 
		'desc'	=> __('Show', 'social-activity'), 
	...
	array( 
		'label'	=> __('More Posts Box', 'social-activity'), 
		'desc'	=> '', 
		...
		'options' => array( 
			'related' => array( 
				'label' => __('Show Related Tab', 'social-activity'),
				'value'	=> 'related' 
			), 
			'popular' => array( 
				'label' => __('Show Popular Tab', 'social-activity'),
				'value'	=> 'popular' 
			), 
			'recent' => array( 
				'label' => __('Show Recent Tab', 'social-activity'),
				'value'	=> 'recent' 
			) 
		) 
	), 
	...
	array( 
		'label'	=> __('Page Color Scheme', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Bottom Sidebar', 'social-activity'), 
		'desc'	=> __('Show', 'social-activity'), 
	...
	array( 
		'label'	=> __('Choose Bottom Sidebar', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Choose Bottom Sidebar Layout', 'social-activity'), 
		'desc'	=> '', 
