...
$cmsms_global_profile_post_details_title = (isset($cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title']) && $cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title'] !== '') ? $cmsms_option[CMSMS_SHORTNAME . '_profile_post_details_title'] : __('Profile details', 'social-activity');
...
$tabs_array['cmsms_profile'] = array( 
	'label' => esc_html__('Profile', 'social-activity'), 
	'value'	=> 'cmsms_profile' 
);
...
$custom_profile_meta_fields = array( 
	...
	array( 
		'label'	=> __('Profile Title', 'social-activity'), 
	...
	array( 
		'label'	=> __('Subtitle', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Details Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Social Icons', 'social-activity'), 
		'desc'	=> __('Add social icons for this profile', 'social-activity'), 
	...
	array( 
		'label'	=> __('Profile Info', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 1 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 1', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 2 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 2', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 3 Title', 'social-activity'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Profile Features 3', 'social-activity'), 
		'desc'	=> '', 
