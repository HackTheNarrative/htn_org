...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<span class="cmsms_slider_post_format_img cmsms-icon-comment-1"></span>
	...
	<?php 
		if (!post_password_required()) {
			...
			echo '<p>' . esc_html__('There is no excerpt because this is a protected post.', 'social-activity') . '</p>';
		}
