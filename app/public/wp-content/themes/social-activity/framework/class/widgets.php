...
class WP_Widget_Custom_Advertisement extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your advertisement', 'social-activity') 
		);
		...
		parent::__construct('custom-advertisement', esc_attr__('Advertisement', 'social-activity'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Advertisement', 'social-activity') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image1'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #1:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link1'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #1:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image2'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #2:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link2'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #2:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image3'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #3:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link3'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #3:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image4'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #4:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link4'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #4:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image5'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #5:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link5'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #5:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('image6'); ?>"><?php esc_html_e('Image', 'social-activity'); ?> #6:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('link6'); ?>"><?php esc_html_e('Link', 'social-activity'); ?> #6:<br />
...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your contact information', 'social-activity') 
		);
		...
		parent::__construct('custom-contact-info', esc_attr__('Contact Information', 'social-activity'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Contact Information', 'social-activity') : $instance['title'], $instance, $this->id_base);
		...
		if ($phone != '') { 
            echo '<span class="contact_widget_phone">' . 
				'<span class="contact_widget_phone_inner">' . esc_html__('Phone', 'social-activity') . ':&nbsp;</span>' . 
				$phone . 
			'</span>';
		}
        ...
        if ($email != '') { 
            echo '<span class="contact_widget_email">' . 
				'<span class="contact_widget_email_inner">' . esc_html__('Email', 'social-activity') . ':&nbsp;</span>' . 
    ...
    function form($instance) {
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('name'); ?>"><?php esc_html_e('Name', 'social-activity'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php esc_html_e('Address', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('city'); ?>"><?php esc_html_e('City', 'social-activity'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('state'); ?>"><?php esc_html_e('State', 'social-activity'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('zip'); ?>"><?php esc_html_e('Zip', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('zip'); ?>" name="<?php echo $this->get_field_name('zip'); ?>" type="text" value="<?php echo $zip; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('phone'); ?>"><?php esc_html_e('Phone', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="text" value="<?php echo $phone; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('email'); ?>"><?php esc_html_e('Email', 'social-activity'); ?>:<br />
...
class WP_Widget_Custom_Divider extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Divider for widgets rows', 'social-activity') 
		);
		
		parent::__construct('custom-divider', esc_attr__('Divider', 'social-activity'), $widget_ops);
	}
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('divider'); ?>"><?php esc_html_e('Show Divider Line', 'social-activity'); ?></label>
		</p>
        <p>
            <label for="<?php echo $this->get_field_id('divider_bdr'); ?>"><?php esc_html_e('Divider Type', 'social-activity'); ?>:<br />
				<select class="widefat" id="<?php echo $this->get_field_id('divider_bdr'); ?>" name="<?php echo $this->get_field_name('divider_bdr'); ?>">
					<option value="solid"<?php if ($divider_bdr == 'solid') { echo ' selected="selected"'; } ?>><?php esc_html_e('Solid Line', 'social-activity'); ?></option>
					<option value="dashed"<?php if ($divider_bdr == 'dashed') { echo ' selected="selected"'; } ?>><?php esc_html_e('Dashed Line', 'social-activity'); ?></option>
					<option value="dotted"<?php if ($divider_bdr == 'dotted') { echo ' selected="selected"'; } ?>><?php esc_html_e('Dotted Line', 'social-activity'); ?></option>
					<option value="transparent"<?php if ($divider_bdr == 'transparent') { echo ' selected="selected"'; } ?>><?php esc_html_e('Transparent Line', 'social-activity'); ?></option>
				</select>
            </label>
        </p>
		<?php
...
class WP_Widget_Custom_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Video from youtube, vimeo or dailymotion', 'social-activity') 
		);
		
		parent::__construct('custom-video', esc_attr__('Embedded Widget', 'social-activity'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Embedded Widget', 'social-activity') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('url'); ?>"><?php esc_html_e('Embed URL', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('width'); ?>"><?php esc_html_e('Max Width', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" type="text" value="<?php echo $width; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('height'); ?>"><?php esc_html_e('Max Height', 'social-activity'); ?>:<br />
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('wrap_embed'); ?>"><?php esc_html_e('If checked, ignore default video height/max-height and set a 16:9 proportion instead', 'social-activity'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Facebook extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Facebook like box', 'social-activity') 
		);
		
		parent::__construct('custom-facebook', esc_attr__('Facebook', 'social-activity'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Facebook', 'social-activity') : $instance['title'], $instance, $this->id_base);
		$url = isset($instance['url']) ? $instance['url'] : '';
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('url'); ?>"><?php esc_html_e('Facebook Page URL', 'social-activity'); ?> :<br />
                <input class="widefat" id="<?php echo $this->get_field_id('url'); ?>" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" />
            </label>
        </p>
        <div class="cl"></div>
...
class WP_Widget_Custom_Flickr extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Flickr account latest images', 'social-activity') 
		);
		
		parent::__construct('custom-flickr', esc_attr__('Flickr', 'social-activity'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Flickr', 'social-activity') : $instance['title'], $instance, $this->id_base);
		...
		echo '<div class="wrap">' . 
			...
			'</div>' . 
			'<div class="cl"></div>' . 
			'<a href="http://www.flickr.com/photos/' . $user . '" class="more_button" target="_blank"><span>' . esc_html__('More flickr images', 'social-activity') . '</span></a>' . 
			'</div>' . 
		$after_widget;
	}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('user'); ?>"><?php esc_html_e('Flickr ID', 'social-activity'); ?> (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):<br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e("Enter the number of latest flickr images you'd like to display", 'social-activity'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'social-activity'); ?> 6</small><br />
            </label>
        </p>
        <div class="cl"></div>
        <?php
...
class WP_Widget_Custom_HTML5_Audio extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your HTML5 Audio', 'social-activity') 
		);
		...
		parent::__construct('custom-html5-audio', esc_attr__('HTML5 Audio', 'social-activity'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('HTML5 Audio', 'social-activity') : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcmp3'); ?>"><?php echo esc_html__('Audio', 'social-activity') . ' .mp3 ' . esc_html__('File Format URL', 'social-activity'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcogg'); ?>"><?php echo esc_html__('Audio', 'social-activity') . ' .ogg ' . esc_html__('File Format URL', 'social-activity'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcwebm'); ?>"><?php echo esc_html__('Audio', 'social-activity') . ' .webm ' . esc_html__('File Format URL', 'social-activity'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('preload'); ?>"><?php esc_html_e('Preload', 'social-activity'); ?>:<br />
				<select class="widefat" id="<?php echo $this->get_field_id('preload'); ?>" name="<?php echo $this->get_field_name('preload'); ?>">
					<option value="none"<?php if ($preload == 'none') { echo ' selected="selected"'; } ?>><?php esc_html_e('Not Preload', 'social-activity'); ?></option>
					<option value="auto"<?php if ($preload == 'auto') { echo ' selected="selected"'; } ?>><?php esc_html_e('Preload Auto', 'social-activity'); ?></option>
					<option value="metadata"<?php if ($preload == 'metadata') { echo ' selected="selected"'; } ?>><?php esc_html_e('Preload as Metadata', 'social-activity'); ?></option>
				</select>
            </label>
        </p>
		<p class="l_half">
			...
			<label for="<?php echo $this->get_field_id('autoplay'); ?>"><?php esc_html_e('Enable Autoplay', 'social-activity'); ?></label>
		</p>
		<p class="r_half">
			...
			<label for="<?php echo $this->get_field_id('loop'); ?>"><?php esc_html_e('Enable Repeat', 'social-activity'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_HTML5_Video extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your HTML5 Video', 'social-activity') 
		);
		...
		parent::__construct('custom-html5-video', esc_attr__('HTML5 Video', 'social-activity'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('HTML5 Video', 'social-activity') : $instance['title'], $instance, $this->id_base);
        $srcmp4 = isset($instance['srcmp4']) ? $instance['srcmp4'] : '';
        $srcogg = isset($instance['srcogg']) ? $instance['srcogg'] : '';
        $srcwebm = isset($instance['srcwebm']) ? $instance['srcwebm'] : '';
        $poster = isset($instance['poster']) ? $instance['poster'] : '';
        $text = (isset($instance['text']) && $instance['text'] != '') ? $instance['text'] : esc_html__('Your browser does not support the video tag.', 'social-activity');
        $preload = isset($instance['preload']) ? $instance['preload'] : 'none';
        $loop = isset($instance['loop']) ? $instance['loop'] : false;
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
		...
		$text = (isset($instance['text']) && $instance['text'] != '') ? esc_html($instance['text']) : esc_html__('Your browser does not support the video tag.', 'social-activity');
		$preload = isset($instance['preload']) ? esc_attr($instance['preload']) : 'none';
        ...
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcmp4'); ?>"><?php echo esc_html__('Video', 'social-activity') . ' .mp4 ' . esc_html__('File Format Source', 'social-activity'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('srcogg'); ?>"><?php echo esc_html__('Video', 'social-activity') . ' .ogg ' . esc_html__('File Format Source', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('srcogg'); ?>" name="<?php echo $this->get_field_name('srcogg'); ?>" type="text" value="<?php echo $srcogg; ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo $this->get_field_id('srcwebm'); ?>"><?php echo esc_html__('Video', 'social-activity') . ' .webm ' . esc_html__('File Format Source', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('srcwebm'); ?>" name="<?php echo $this->get_field_name('srcwebm'); ?>" type="text" value="<?php echo $srcwebm; ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo $this->get_field_id('poster'); ?>"><?php esc_html_e('Poster URL', 'social-activity'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest projects from your portfolio', 'social-activity') 
		);
		
		parent::__construct('custom-latest-projects', esc_attr__('Latest Projects', 'social-activity'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Latest Projects', 'social-activity') : $instance['title'], $instance, $this->id_base);
            ...
            while ($lp->have_posts()) : $lp->the_post();
				...
				if ($pj_format == 'video') {
					echo '<div class="latest_pj_img">' . 
						'<span class="img_placeholder cmsms-icon-video-2"></span>' . 
					'</div>';
				} else {
					if (has_post_thumbnail()) {
						...
						echo '<div class="latest_pj_img">' . 
							'<span class="img_placeholder cmsms-icon-camera-2"></span>' . 
						'</div>';
					}
				}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('type'); ?>"><?php esc_html_e('Show Only from Projects Type', 'social-activity'); ?>:<br />
                <select id="<?php echo $this->get_field_id('type'); ?>" name="<?php echo $this->get_field_name('type'); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Show all projects', 'social-activity'); ?>&nbsp;</option>
				<?php 
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e("Enter the number of latest projects you'd like to display", 'social-activity'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'social-activity'); ?> 3</small><br />
            </label>
        </p>
		<p>
			<input class="checkbox" type="checkbox" <?php checked($instance['autoplay'], true); ?> id="<?php echo $this->get_field_id('autoplay'); ?>" name="<?php echo $this->get_field_name('autoplay'); ?>" /> 
			<label for="<?php echo $this->get_field_id('autoplay'); ?>"><?php esc_html_e('Autoplay', 'social-activity'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Popular projects from your portfolio', 'social-activity') 
		);
		
		parent::__construct('custom-popular-projects', esc_attr__('Popular Projects', 'social-activity'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Popular Projects', 'social-activity') : $instance['title'], $instance, $this->id_base);
		$type = isset($instance['type']) ? $instance['type'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e("Enter the number of popular projects you'd like to display", 'social-activity'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'social-activity'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest, popular posts & recent comments', 'social-activity') 
		);
		
		parent::__construct('custom-posts-tabs', esc_attr__('Posts Tabs', 'social-activity'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if ($latest) {
			echo '<li class="cmsms_tabs_list_item current_tab">' . 
				'<a href="#"><span>' . esc_html__('Latest', 'social-activity') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($popular) {
			echo '<li class="cmsms_tabs_list_item' . ((!$latest) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Popular', 'social-activity') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($recent) {
			echo '<li class="cmsms_tabs_list_item' . ((!$latest && !$popular) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Comments', 'social-activity') . '</span></a>' . 
			'</li>'; 
		}
		...
		if ($pt_format == 'aside') {
			$widget_icon = 'cmsms-icon-megaphone-1';
		} elseif ($pt_format == 'audio') {
			$widget_icon = 'cmsms-icon-music-1';
		} elseif ($pt_format == 'chat') {
			$widget_icon = 'cmsms-icon-star-2';
		} elseif ($pt_format == 'gallery') {
			$widget_icon = 'cmsms-icon-picture-2';
		} elseif ($pt_format == 'image') {
			$widget_icon = 'cmsms-icon-camera-2';
		} elseif ($pt_format == 'link') {
			$widget_icon = 'cmsms-icon-globe-1';
		} elseif ($pt_format == 'quote') {
			$widget_icon = 'cmsms-icon-comment-1';
		} elseif ($pt_format == 'status') {
			$widget_icon = 'cmsms-icon-user-2';
		} elseif ($pt_format == 'video') {
			$widget_icon = 'cmsms-icon-videocam-1';
		} else {
			$widget_icon = 'cmsms-icon-monitor';
		}
			...
			if ($l->have_posts()) { 
				...
				while ($l->have_posts()) : $l->the_post();
					...
					if ($pt_format != 'aside' && $pt_format != 'link' && $pt_format != 'quote') {
						...
						'<br />' . 
						'<small>' . 
							'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ' . esc_html__('ago', 'social-activity') . '</abbr>' . 
						'</small>';
					} elseif ($pt_format == 'link') {
			...
			if ($rcomments) { 
				...
				foreach ($rcomments as $comment) {
					...
					echo '<li>' . 
						...
						' <span class="color_2">' . esc_html__('on', 'social-activity') . '</span> <a href="' . esc_url(get_permalink($comment_post_ID)) . '#comments" rel="bookmark">' . cmsms_title($comment_post_ID, false) . '</a>' . 
						'<small>' . 
							'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff($comment_date, current_time('timestamp')) . ' ' . esc_html__('ago', 'social-activity') . '</abbr>' . 
						'</small>' . 
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('latest'); ?>"><?php esc_html_e('Latest Posts', 'social-activity'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular'); ?>"><?php esc_html_e('Popular Posts', 'social-activity'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent'); ?>"><?php esc_html_e('Recent Comments', 'social-activity'); ?></label>
		</p>
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e("Enter the number of recent comments, popular and latest posts you'd like to display", 'social-activity'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'social-activity'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Twitter account latest tweets', 'social-activity') 
		);
		
		parent::__construct('custom-twitter', esc_attr__('Twitter', 'social-activity'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Twitter', 'social-activity') : $instance['title'], $instance, $this->id_base);
		$user = isset($instance['user']) ? $instance['user'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
		...
		if ($user != '') {
			...
			if ($tweets != '') {
				...
				foreach ($tweets as $t) {
					echo '<li>' . "\n" . 
						'<span class="tweet_time">' . human_time_diff( $t['time'], current_time('timestamp') ) . ' ' . esc_html__('ago', 'social-activity') . '</span>' . "\n" . 
				...
				echo '<div class="cmsms_notice cmsms_notice_error cmsms-icon-cancel-2">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'social-activity') . ', ' . '<a target="_blank" href="http://docs.cmsmasters.net/admin2/twitter-functionality/">' . esc_html__('read more how', 'social-activity') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('user'); ?>"><?php esc_html_e('Twitter Username', 'social-activity'); ?>:<br />
                <input class="widefat" id="<?php echo $this->get_field_id('user'); ?>" name="<?php echo $this->get_field_name('user'); ?>" type="text" value="<?php echo $user; ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e("Enter the number of latest tweets you'd like to display", 'social-activity'); ?>:<br /><br />
                <input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'social-activity'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_PayPalDonations extends WP_Widget {
		...
		echo $before_widget . 
			'<div class="cmsms_paypal_donations_widget">' . "\n";
				...
				echo '<div class="cmsms_paypal_donations">' . "\n" . 
					...
					'<span class="button">' . ($button_text ? $button_text : esc_html__('Donate', 'social-activity')) . '</span>' . "\n" . 
				'</div>' . "\n" . 
			'</div>' . "\n" . 
		$after_widget;
    }
    ...
    public function form($instance) {
		$defaults = array(
			'title' => 			esc_attr__('Donate', 'social-activity'),
			'text' => 			'',
			'purpose' => 		'',
			'reference' => 		'',
			'amount' => 		'',
		...
		<p>
			<label for="<?php echo $amount_id; ?>"><?php esc_html_e('Amount:', 'social-activity'); ?> 
			<input class="widefat" id="<?php echo $amount_id; ?>" name="<?php echo $amount_name; ?>" type="text" value="<?php echo esc_attr($instance['amount']); ?>" />
			</label>
		</p>
		<p>
			<label for="<?php echo $button_text_id; ?>"><?php esc_html_e('Button Text:', 'social-activity'); ?> 
