...
function register_js_scripts() {
	if (!is_admin()) {
		...
		wp_localize_script('script', 'cmsms_script', array( 
			...
			'ilightbox_close_text' => 				__('Close', 'social-activity'), 
			'ilightbox_enter_fullscreen_text' => 	__('Enter Fullscreen (Shift+Enter)', 'social-activity'), 
			'ilightbox_exit_fullscreen_text' => 	__('Exit Fullscreen (Shift+Enter)', 'social-activity'), 
			'ilightbox_slideshow_text' => 			__('Slideshow', 'social-activity'), 
			'ilightbox_next_text' => 				__('Next', 'social-activity'), 
			'ilightbox_previous_text' => 			__('Previous', 'social-activity'), 
			'ilightbox_load_image_error' => 		__('An error occurred when trying to load photo.', 'social-activity'), 
			'ilightbox_load_contents_error' => 		__('An error occurred when trying to load contents.', 'social-activity'), 
			'ilightbox_missing_plugin_error' => 	__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'social-activity') 
		));
...
function the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => __('Sidebar', 'social-activity'), 
            'id' => 'sidebar_default', 
            'description' => __('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'social-activity'), 
    ...
    register_sidebar(
        array(
            'name' => __('Bottom Sidebar', 'social-activity'), 
            'id' => 'sidebar_bottom', 
            'description' => __('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'social-activity'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsms_option[CMSMS_SHORTNAME . '_sidebar']) && sizeof($cmsms_option[CMSMS_SHORTNAME . '_sidebar']) > 0) {
		foreach ($cmsms_option[CMSMS_SHORTNAME . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				...
				'description' => __('Custom sidebar created with cmsmasters admin panel.', 'social-activity'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
register_nav_menus(array( 
    'primary' => 	__('Primary Navigation', 'social-activity'), 
    'footer' => 	__('Footer Navigation', 'social-activity'), 
	'top_line' => 	__('Top Line Navigation', 'social-activity') 
));
...
function sidebarDefaultText() {
	...
	'<aside id="archives" class="widget widget_archive">' . "\n" . 
		'<h3 class="widgettitle">' . esc_html__('Archives', 'social-activity') . '</h3>' . "\n" . 
		'<ul>' . "\n";
	...
	'<aside id="meta" class="widget widget_meta">' . "\n" . 
		'<h3 class="widgettitle">' . esc_html__('Meta', 'social-activity') . '</h3>' . "\n" . 
		'<ul>' . "\n\t";
	...
	echo '" title="' . esc_attr__('Syndicate this site using RSS 2.0', 'social-activity') . '">' . esc_html__('Entries', 'social-activity') . ' ' . 
			'<abbr title="' . esc_attr__('Really Simple Syndication', 'social-activity') . '">' . esc_html__('RSS', 'social-activity') . '</abbr>' . 
		'</a>' . 
	'</li>' . "\n\t" . 
	'<li>' . 
		'<a href="';
	...
	echo '" title="' . esc_attr__('The latest comments to all posts in RSS', 'social-activity') . '">' . esc_html__('Comments', 'social-activity') . ' ' . 
					'<abbr title="' . esc_attr__('Really Simple Syndication', 'social-activity') . '">' . esc_html__('RSS', 'social-activity') . '</abbr>' . 
				'</a>' . 
			'</li>' . "\n\t" . 
			'<li>' . 
				'<a href="http://wordpress.org/" title="' . esc_attr__('Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'social-activity') . '">WordPress.org</a>' . 
			'</li>' . "\r" . 
		'</ul>' . "\n" . 
	'</aside>' . "\n";
}
