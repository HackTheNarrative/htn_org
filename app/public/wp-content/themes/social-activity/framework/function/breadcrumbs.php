...
function breadcrumbs() {
	...
	$homeText = __('Home', 'social-activity');
	...
	echo '<span>' . esc_html__('You are here: ', 'social-activity') . '</span>' . "\n\t\t" . 
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search Results for', 'social-activity') . "</span>: '" . get_search_query() . "'";
		...
		echo '<span>' . esc_html__('No Breadcrumbs', 'social-activity') . '</span>';
	}
}
