...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.widget_shopping_cart_content .buttons .button.checkout:hover, 
	...
	{$rule}.widget_shopping_cart_content .buttons .button.checkout, 
...
/***************** Start {$title} Events Color Scheme Rules ******************/
	...
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a span:before, 
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a span:after, 
	...
	/* Start Main Background Color */
	{$rule}.widget .this-week-today .tribe-this-week-widget-header-date * , 
	{$rule}#tribe-events-bar #tribe-bar-views .tribe-bar-views-inner ul.tribe-bar-views-list li.tribe-bar-views-option a, 
	{$rule}#tribe-events-content.tribe-events-month table.tribe-events-calendar thead th, 
	{$rule}#tribe-events-content.tribe-events-month table.tribe-events-calendar tbody td.tribe-events-present div[id*=\"tribe-events-daynum-\"], 
	...
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a, 
	...
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a:hover span {
		" . cmsms_color_css('background-color', $cmsms_option[CMSMS_SHORTNAME . '_' . $scheme . '_border']) . "
	}
	
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a:hover span:before, 
	{$rule}.tribe-this-week-events-widget .tribe-events-sub-nav li a:hover span:after, 
	...
	{$rule}.widget	div.tribe-this-week-widget-day + div.tribe-this-week-widget-day, 
...
/***************** Start Header Bottom Color Scheme Rules ******************/
	...
	#page.fixed_header .header_bot_outer {
		background-color:rgba(" . hex2rgb($cmsms_header_bottom_bg[0]) . ", " . ((int) $cmsms_header_bottom_bg[1] / 100) . ");
	}
	";
